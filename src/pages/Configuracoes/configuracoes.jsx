...
const Configuracoes = () => {
  ...
  const handleSubmitCupom = (event) => {
    ...
    fetch("http://localhost:3001/cupons", {
      ...
      body: JSON.stringify({ nome: nomeCupom, validade: validadeCupom }),
    })
      .then((response) => response.json())
  ...
  return (
    <div className={styles.telaCores}>
      <div className={styles.lateral}>
        <lu>
          <li>
            <a
              className={mostrar == "Cores" ? "activePerfil" : ""}
              onClick={() => setMostrar("Cores")}
            >
              Cores
            </a>
          </li>
          <li>
            <a
              ...
              onClick={() => setMostrar("BannerEnvio")}
            >
              Enviar banners
            </a>
          </li>
          <li>
            <a
              ...
              onClick={() => setMostrar("BannerGerenciar")}
            >
              Gerenciar banners
            </a>
          </li>
      ...
      <div className={styles.principal}>
        ...
        {mostrar == "BannerGerenciar" && (
          <>
            ...
            {lista &&
              lista.map((result) => (
                <div key={result.id} className={styles.banner_row}>
                  <p>
                    <img
                      className={styles.previaBanner}
                      src={result.image}
                      alt="banner"
                    />
                  </p>
